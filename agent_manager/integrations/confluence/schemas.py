"""Pydantic request schemas for Confluence endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class ConfluenceApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Confluence integration assigned.")
