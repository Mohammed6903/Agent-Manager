"""Pydantic request schemas for Mailchimp endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class MailchimpApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Mailchimp integration assigned.")
