"""Pydantic request schemas for Monday endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class MondayApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Monday integration assigned.")
