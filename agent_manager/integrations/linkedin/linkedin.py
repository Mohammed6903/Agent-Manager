...
from agent_manager.integrations.base import BaseSDKIntegration, AuthFieldDef, EndpointDef, AuthFlowType, MetadataFieldDef, MetadataFieldType
...
class LinkedInIntegration(BaseSDKIntegration):
    ...
    from .flow import LinkedInOAuth2Flow
