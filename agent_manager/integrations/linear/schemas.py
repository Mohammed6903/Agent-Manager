"""Pydantic request schemas for Linear endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class LinearApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Linear integration assigned.")
