"""Pydantic request schemas for Jira endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class JiraApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Jira integration assigned.")
