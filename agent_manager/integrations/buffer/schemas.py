"""Pydantic request schemas for Buffer endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class BufferApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Buffer integration assigned.")
