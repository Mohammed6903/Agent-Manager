"""Pydantic request schemas for Calendly endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class CalendlyApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Calendly integration assigned.")
