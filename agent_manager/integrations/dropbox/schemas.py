"""Pydantic request schemas for Dropbox endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class DropboxApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Dropbox integration assigned.")
