"""Pydantic request schemas for Pipedrive endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class PipedriveApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Pipedrive integration assigned.")
