"""Pydantic request schemas for Salesforce endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class SalesforceApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Salesforce integration assigned.")
