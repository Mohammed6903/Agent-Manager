"""Pydantic request schemas for Zoho CRM endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class ZohoCRMApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the Zoho CRM integration assigned.")
