"""Pydantic request schemas for SendGrid endpoints."""

from typing import Any, Dict, Optional
from pydantic import BaseModel, Field


class SendGridApiRequest(BaseModel):
    agent_id: str = Field(..., description="The agent that has the SendGrid integration assigned.")
